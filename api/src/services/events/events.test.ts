...
describe('events', () => {
  ...
  scenario('creates a event', async () => {
    const result = await createEvent({
      input: {
        name: 'String',
        startAt: '2023-11-02T21:30:45.206Z',
        endAt: '2023-11-02T21:30:45.206Z',
        registrationStartAt: '2023-11-02T21:30:45.206Z',
        registrationEndAt: '2023-11-02T21:30:45.206Z',
      },
    });

    expect(result.name).toEqual('String');
    expect(result.startAt).toEqual(new Date('2023-11-02T21:30:45.206Z'));
    expect(result.endAt).toEqual(new Date('2023-11-02T21:30:45.206Z'));
    expect(result.registrationStartAt).toEqual(
      new Date('2023-11-02T21:30:45.206Z')
    );
